const Instructions = () => {
	...
	return (
		<div class="container mx-auto p-4 bg-white m-4 rounded">
			<h1 class="text-3xl font-bold mb-4">Manual de Usuario</h1>
			...
			<div class="mb-8">
				<h2 class="text-xl font-bold mb-2">Registro de Usuarios</h2>
			...
			<div class="mb-8">
				<h2 class="text-xl font-bold mb-2">Autenticación</h2>
				<ul class="list-disc pl-4">
			...
			<div class="mb-8">
				<h2 class="text-xl font-bold mb-2">Gestión de Productos y Contactos</h2>
				<ul class="list-disc pl-4">
			...
			<div class="mb-8">
				<h2 class="text-xl font-bold mb-2">Órdenes de Compra</h2>
				<ul class="list-disc pl-4">
			...
			<p class="mt-8">¡Gracias por utilizar nuestra aplicación de gestión de órdenes de compra!</p>
		</div>
