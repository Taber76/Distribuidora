...
einvoiceRouter.post('/register', auth_mid_1.default.authenticate('adminJWT', { session: false }), einvoice_controller_1.default.register);
einvoiceRouter.get('/getAll', einvoice_controller_1.default.getAll);
